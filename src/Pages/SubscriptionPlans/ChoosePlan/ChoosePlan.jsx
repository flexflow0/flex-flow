...
<div className="p-8 w-[24%]">
    ...
    <div className="">
        ...
        <p className="text-md flex gap-2 items-center"><FaCheck className="text-purple-800  text-xl"></FaCheck>No commitments,cancel at any  time.</p>
        <p className="text-md flex gap-2 items-center py-2"><FaCheck className="text-purple-800  text-xl"></FaCheck>Everything on Flexflow for one  low price.</p>
        <p className="text-md flex gap-2 items-center"><FaCheck className="text-purple-800  text-xl"></FaCheck>No adverts and no extra fees. Ever.</p>
    </div>
