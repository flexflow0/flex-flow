...
const CheckForm = ({ setDisable }) => {
    ...
    useEffect(() => {
        ...
        if (price > 0) {
            axios('https://flex-flow-server-gold.vercel.app/create-payment-intent')
                .then(res => {
            ...
            if (price > 0) {
                axios.post('https://flex-flow-server-gold.vercel.app/create-payment-intent', { price }).then(res => {
    ...
    const handleSubmit = async (event) => {
        ...
        if (clientSecret) {
            ...
            if (paymentIntent.status === 'succeeded') {
                ...
                console.log(payment);
                fetch('https://flex-flow-server-gold.vercel.app/payment-stripe', {
                    method: "POST",
