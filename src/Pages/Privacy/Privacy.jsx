    ...
    <div>
      <div className='px-20'>
        ...
        <div className='mt-12'>
          ...
          <ul className='ml-10 text-[20px] mt-4'>
            <li>
        ...
        <div className='mt-12'>
          ...
          <p className=' mt-4'>To see the prior version of this document, please go to flexflow.com/privacyupdates </p>
      ...
      <div className='flex flex-col items-center justify-center mb-16'>
        <Link to="/home">
          <button className='text-2xl bg-purple-900 rounded mt-5 p-3 text-center'> Back to Help Home</button>
        </Link>
      </div>
      <hr className='border border-[#830FEA]' />
    </div >
