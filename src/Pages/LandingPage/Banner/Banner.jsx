    ...
    return (
        ...
        >
            ...
            <div className='relative mx-auto mb-20 w-full sm:w-96 md:w-[500px] '>
                {/* Subscribe Email */}
                <input required className='pl-4 py-5 h-10 w-full sm:w-96 md:w-[500px] bg-transparent border-2 border-[#830fea] input rounded-full text-white' type="email" placeholder='Enter Your Email' />
                {/* Subscribe button */}
                <Link to='/home'>
