...
const WatchOffline = () => {
    return (
        <div className="border-y-2 border-purple-800">
            <div className="lg:flex md:flex MyContainer justify-between mx-auto lg:my-28 lg:h-[450px] text-white">
                ...
                <div className=" lg:my-auto mx-auto mb-4 ml-5  w-full">
                    <h1 className="lg:text-6xl md:text-5xl text-4xl font-bold md:pt-7">Download your<br /> shows  to  watch<br /> offline</h1>
